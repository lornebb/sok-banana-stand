...
import { SiSpotify, SiApplemusic, SiBandcamp, SiTidal, SiYoutube, SiInstagram } from 'react-icons/si'

const date = new Date()
const yearToday = date.getFullYear()

const SoMeList = [
  { title: 'BandCamp', href: 'https://sonofkong.bandcamp.com/', icon: <SiBandcamp /> },
  {
    title: 'Spotify',
  ...
  { title: 'Tidal', href: 'https://tidal.com/browse/artist/8412421', icon: <SiTidal /> },
  {
    title: 'Youtube',
